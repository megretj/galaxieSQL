...
<input-feedback 
data-title="Écris son nom ici (sans majuscule):"
...
## Exercice
La chercheuse Lou a ajouté un alien dans la base de données, il s'appelle "CLETHRA_6111". 
...
Génère ensuite un portrait robot de CLETHRA_6111 afin de pouvoir le montrer aux autres aliens. 
